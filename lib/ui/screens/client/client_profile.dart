            ...
            children: <Widget>[
              ...
              StreamBuilder<Map<String, dynamic>>(
                ...
                builder: (context, snapshot) {
                  ...
                  displayName =
                      "${userData['firstName'].toUpperCase()} ${userData['middleName'].toUpperCase()} ${userData['lastName'].toUpperCase()}" ??
                          'No Name';
                  imageURL = userData['idPicture'];
                  ...
                  showDialog(
                    ...
                    builder: (BuildContext context) {
                      return AlertDialog(
                        ...
                        content: const Text(
                            "Please contact Barangay to update your personal information."),
                        actions: <Widget>[
                          CustomButton(
                            buttonLabel: "OK",
                            onPressed: () {
                ...
                onPressed: () {
                  navigateWithSlideFromRight(
                    ...
                    const UserPhoneNumber(
                      text: "The primary purpose of collecting the phone number is for Barangay Putatan to contact the individual."
                    ),
                    1.0,
                    0.0,
                  );
                ...
                onPressed: () {
                  navigateWithSlideFromRight(
                    ...
                    const UserEmailAddress(
                      text: "Your email address may be used for account updates or to improve accessibility to our services."
                    ),
                    1.0,
                    0.0,
                  );
              ...
              const CustomTextDescription(
                descriptionText:
                    "Your information will be used solely by Barangay Putatan Admin for validation purposes and will not be"
                    "publicly displayed or shared with other residents.",
                hasLearnMore: "",
              ),
