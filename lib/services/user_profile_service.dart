...
import 'package:putatanapk/services/image_compression.dart';
    ...
    if (formKey.currentState!.validate()) {
      try {
        ...
        if (currentUser != null) {
          ...
          if (middleNameController != null) {
            dataToUpdate['middleName'] = middleNameController.text.trim();
          }
          if (lastNameController != null) {
            dataToUpdate['lastName'] = lastNameController.text.trim();
          }
          if (genderController != null) {
            dataToUpdate['genderController'] = genderController.text.trim();
          }
          ...
          if (creditCardNumberController != null) {
            dataToUpdate['creditCardNumber'] = creditCardNumberController.text.trim();
          }
          if (statusController != null) {
            dataToUpdate['statusController'] = statusController.text.trim();
          }
